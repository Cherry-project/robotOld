...
class LittleLaughBehave(pypot.primitive.Primitive):
    def run(self):
        poppy = self.robot
        ...
        poppy.bust_y.goto_position(20, 0.5, wait=True)
        poppy.abs_z.goto_position(4, 0.3, wait=True)
        poppy.abs_z.goto_position(-4, 0.3, wait=True)
        poppy.abs_z.goto_position(4, 0.3, wait=True)
        poppy.abs_z.goto_position(-4, 0.3, wait=True)
        poppy.abs_z.goto_position(0, 0.3, wait=False)
        poppy.bust_y.goto_position(0, 0.5, wait=True)
        ...
        poppy.l_elbow_y.goto_position(-50, 1.5, wait=False)
