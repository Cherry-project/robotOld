...
class YouAndMeBehave(pypot.primitive.Primitive):
    def run(self):
        poppy = self.robot
        ...
        poppy.l_arm_z.moving_speed = abs(-60 - poppy.l_arm_z.present_position)
        ...
        poppy.l_arm_z.goal_position = -60
        ...
        poppy.l_arm_z.goto_position(-60, 1.5, wait=False)
