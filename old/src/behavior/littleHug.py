...
class LittleHugBehave(pypot.primitive.Primitive):
    def run(self):
        poppy = self.robot
        ...
        poppy.r_shoulder_y.moving_speed = abs(-45 - poppy.r_shoulder_y.present_position)
        ...
        poppy.r_elbow_y.moving_speed = abs(30 - poppy.r_elbow_y.present_position)


        poppy.l_shoulder_y.moving_speed = abs(-45 - poppy.l_shoulder_y.present_position)
        ...
        """
        poppy.r_shoulder_y.goto_position(-45, 1.5, wait=False)
        poppy.r_shoulder_x.goto_position(-30, 1.5, wait=False)
        poppy.r_arm_z.goto_position(-10, 1.5, wait=False)
        poppy.r_elbow_y.goto_position(30, 1.5, wait=False)

        poppy.l_shoulder_y.goto_position(-45, 1.5, wait=False)
