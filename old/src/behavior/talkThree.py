...
class TalkThreeBehave(pypot.primitive.Primitive):  
    ...
    def run(self):
        ...
        poppy.l_elbow_y.goto_position(-20, 3, wait=False)
        poppy.l_shoulder_y.goto_position(-50, 3, wait=True)

        poppy.l_elbow_y.goto_position(-100, 3, wait=False)
        poppy.l_arm_z.goto_position(-40, 3, wait=True)
        
        poppy.l_elbow_y.goto_position(-60, 3, wait=False)
        poppy.l_arm_z.goto_position(20, 3, wait=True)
