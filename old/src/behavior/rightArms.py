...
class RightArmsBehave(pypot.primitive.Primitive):
    def run(self):
        poppy = self.robot
        ...
        poppy.r_arm_z.moving_speed = abs(-45 - poppy.r_arm_z.present_position)
        poppy.r_elbow_y.moving_speed = abs(0 - poppy.r_elbow_y.present_position)
        ...
        poppy.l_arm_z.moving_speed = abs(-45 - poppy.l_arm_z.present_position)
        poppy.l_elbow_y.moving_speed = abs(0 - poppy.l_elbow_y.present_position)
        ...
        poppy.r_arm_z.goto_position(45, 1.5, wait=False)
        ...
        poppy.l_arm_z.goto_position(45, 1.5, wait=False)
