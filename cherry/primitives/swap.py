...
class SwapBehave(pypot.primitive.Primitive):
    def run(self):
        poppy = self.robot
        ...
        """
        poppy.r_shoulder_y.goto_position(0, 0.5, wait=False)
        poppy.r_shoulder_x.goto_position(-10, 0.5, wait=False)
        poppy.r_arm_z.goto_position(-30, 0.5, wait=False)
        poppy.r_elbow_y.goto_position(5, 0.5, wait=False)

        poppy.l_shoulder_y.goto_position(0, 0.5, wait=False)
        poppy.l_shoulder_x.goto_position(10, 0.5, wait=False)
        poppy.l_arm_z.goto_position(30, 0.5, wait=False)
        poppy.l_elbow_y.goto_position(5, 0.5, wait=True)
        ...
        poppy.l_shoulder_y.goto_position(0, 0.5, wait=False)
        poppy.l_shoulder_x.goto_position(10, 0.5, wait=False)
        poppy.l_arm_z.goto_position(-20, 0.5, wait=False)
        poppy.l_elbow_y.goto_position(5, 0.5, wait=True)
